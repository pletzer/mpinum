...
class TestMaskedDistArray(unittest.TestCase):
    ...
    def test0(self):
        ...
        Test constructors
        """
        da = pnumpy.mdaZeros( (2,3), numpy.float64 )
        da = pnumpy.mdaOnes( (2,3), numpy.float64 )
        da = pnumpy.mdaArray( [1,2,3] )
    ...
    def test2d_1(self):
        ...
        da = pnumpy.mdaZeros( (2,3), numpy.float32 )
